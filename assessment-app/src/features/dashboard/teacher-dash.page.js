            ...
            <main class="max-w-5xl mx-auto p-4 space-y-10 mt-8">
                ...
                <section>
                    <div class="flex items-center gap-3 mb-6 pl-1">
                        <h2 class="text-xs font-black text-gray-400 uppercase tracking-[0.3em]">Institutional Management</h2>
                            ...
                            <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
                                <div class="flex items-center gap-8">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-400 text-xs font-bold uppercase tracking-[0.2em] mt-2">Manage Curriculum & Question Items</p>
                                    </div>
                                </div>
                            ...
                            <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
                                <div class="flex items-center gap-8">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-400 text-xs font-bold uppercase tracking-[0.2em] mt-2">Draft, Deploy & Monitor Exams</p>
                                    </div>
                                </div>
                            ...
                            <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
                                <div class="flex items-center gap-8">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-400 text-xs font-bold uppercase tracking-[0.2em] mt-2">Enrollment, Student Performance & Grades</p>
                                    </div>
                                </div>

            ...
            <main class="max-w-5xl mx-auto p-4 space-y-8 mt-4">
                ...
                <section>
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div onclick="location.hash='#class-manager'" class="group bg-emerald-600 p-8 rounded-3xl shadow-xl shadow-emerald-100 cursor-pointer active:scale-[0.98] transition-all outline outline-0 outline-emerald-200 hover:outline-8">
                            <div class="w-14 h-14 bg-white/20 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
